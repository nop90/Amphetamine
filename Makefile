...
APP_TITLE		:= Amphetamine 3ds
APP_DESCRIPTION	:= Amphetamine is an exciting jump'n run game. You must fight eleven evil monsters with your magic weapons.
...
LIBS	:= -lSDL -lpng -ljpeg -lz -lcitro3d -lctru -lm
